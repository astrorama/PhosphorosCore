...
#ifndef _REFERENCESAMPLE_LEGACYINDEXPROVIDER_H
#define _REFERENCESAMPLE_LEGACYINDEXPROVIDER_H
...
public:
   ...
   * @brief Destructor
   */
  virtual ~LegacyIndexProvider() = default;
   ...
   */
  LegacyIndexProvider(const boost::filesystem::path &path);

  /**
   * Move constructor
   */
  LegacyIndexProvider(LegacyIndexProvider &&) = default;
