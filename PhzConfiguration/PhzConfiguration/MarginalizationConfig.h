...
public:
  ...
  void addMarginalizationCorrection(PhzLikelihood::BayesianMarginalizationFunctor::AxisCorrection corr);
  
private:
  
  PhzLikelihood::CatalogHandler::MarginalizationFunction m_marginalization_function;
  std::vector<PhzLikelihood::BayesianMarginalizationFunctor::AxisCorrection> m_corrections;
