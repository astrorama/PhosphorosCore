...
/**
 * @file PhzConfiguration/CorrectionCoefficientGridConfig.h
 * @date 16//11/08
 * @author Florioan Dubath
 */

#ifndef _PHZCONFIGURATION_CORRECTIONCOEFFICIENTCONFIG_H
#define _PHZCONFIGURATION_CORRECTIONCOEFFICIENTCONFIG_H.h
...
/**
 * @class CorrectionCoefficientGridConfig
 *
 * @brief
 * Configuration class for defining a photometry grid as input
 */
class CorrectionCoefficientGridConfig : public Configuration::Configuration {

public:

  /// Constructs a new PhotometryGridConfig object
  CorrectionCoefficientGridConfig(long manager_id);

  /**
   * @brief Destructor
   */
  virtual ~CorrectionCoefficientGridConfig() = default;
   ...
   */
  const PhzDataModel::PhotometryGridInfo& getCorrectionCoefficientGridInfo();
   ...
   *    If the instance in not yet initialized
   */
  const std::map<std::string, PhzDataModel::PhotometryGrid>& getCorrectionCoefficientGrid();
...
}; /* End of CorrectionCoefficientGridConfig class */
