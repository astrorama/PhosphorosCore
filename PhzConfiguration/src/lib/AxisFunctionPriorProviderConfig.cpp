...
AxisFunctionPriorProviderConfig::AxisFunctionPriorProviderConfig(long manager_id)
...
const std::shared_ptr<XYDataset::XYDatasetProvider> AxisFunctionPriorProviderConfig::getAxisFunctionPriorDatasetProvider() {
