...
ComputePhotometricCorrectionsConfig::ComputePhotometricCorrectionsConfig(long manager_id)
...
void ComputePhotometricCorrectionsConfig::preInitialize(const UserValues& args) {
  ...
  if (method != "MEDIAN" && method != "WEIGHTED_MEDIAN" &&
      method != "MEAN" && method != "WEIGHTED_MEAN") {
...
ComputePhotometricCorrectionsConfig::PhotCorrSelectorType initializePhotCorrSelector(
