...
public:
  ...
  MOCK_METHOD3(FunctorCall, map<int64_t,  SourceCatalog::Photometry>(
  ...
  void expectFunctorCall(const Catalog& expected_catalog,
                         ...
                         const map<int64_t, SourceCatalog::Photometry>& result) {
...
public:
  ...
  MOCK_METHOD3(FunctorCall, map<int64_t, double>(
                  ...
                  const map<int64_t,  SourceCatalog::Photometry>& model_phot_map));
  void expectFunctorCall(Catalog::const_iterator expected_source_begin,
                         Catalog::const_iterator expected_source_end,
                         const map<int64_t, SourceCatalog::Photometry>& expected_model_phot_map,
                         const map<int64_t, double> result) {
    EXPECT_CALL(*this, FunctorCall(_, _,
        Truly([&expected_model_phot_map](const map<int64_t,  SourceCatalog::Photometry>& model_phot_map) {
...
BOOST_AUTO_TEST_CASE(FunctorCallSuccess) {
  ...
  vector<std::map<int64_t,  SourceCatalog::Photometry>> best_fit_map_list {
