...
struct CompositeLuminosityFunction_Fixture {
  ...
  CompositeLuminosityFunction_Fixture(){
   ...
   auto f1 = new PhzLuminosity::CustomLuminosityFunction{std::move(dataset)};
   ...
   auto f2 = new PhzLuminosity::CustomLuminosityFunction{std::move(dataset2)};
   ...
   auto f3 = new PhzLuminosity::CustomLuminosityFunction{std::move(dataset3)};
