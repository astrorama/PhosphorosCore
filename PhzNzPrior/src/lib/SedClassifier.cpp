...
double computeB_I(const PhzDataModel::FilterInfo& filter_b, const PhzDataModel::FilterInfo& filter_i,
...
SedClassifier::SedClassifier(std::shared_ptr<XYDataset::XYDatasetProvider> filter_provider,
                             std::shared_ptr<XYDataset::XYDatasetProvider> sed_provider, double bi_break_1,
                             double bi_break_2)
    : m_filter_provider{filter_provider}, m_sed_provider{sed_provider}, m_break_1{bi_break_1}, m_break_2{bi_break_2} {
...
PhzDataModel::QualifiedNameGroupManager
SedClassifier::operator()(const XYDataset::QualifiedName& b_filter, const XYDataset::QualifiedName& i_filter,
