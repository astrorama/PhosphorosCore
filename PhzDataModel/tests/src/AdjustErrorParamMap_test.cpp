...
struct AdjustErrorParamMap_Fixture {
  ...
  PhzDataModel::AdjustErrorParamMap ref_map =
      PhzDataModel::AdjustErrorParamMap{{filter1, std::make_tuple(1.1, 2.1, 3.1)},
  ...
  std::string string_representation_wrong_name3 = "# Column: Filter string\n"
                                                  "# Column: Alpha double\n"
                                                  "# Column: Beth double\n"
                                                  "# Column: Gamma double\n"
                                                  "\n"
  ...
  std::string string_representation_wrong_name4 = "# Column: Filter string\n"
                                                  "# Column: Alpha double\n"
                                                  "# Column: Beta double\n"
  ...
  std::string string_representation_wrong_type2 = "# Column: Filter double\n"
                                                  "# Column: Alpha string\n"
                                                  "# Column: Beta double\n"
                                                  "# Column: Gamma double\n"
                                                  "\n"
  ...
  std::string string_representation_wrong_type3 = "# Column: Filter double\n"
                                                  "# Column: Alpha double\n"
                                                  "# Column: Beta string\n"
                                                  "# Column: Gamma double\n"
                                                  "\n"
  ...
  std::string string_representation_wrong_type4 = "# Column: Filter double\n"
                                                  "# Column: Alpha double\n"
                                                  "# Column: Beta double\n"
                                                  "# Column: Gamma string\n"
                                                  "\n"
