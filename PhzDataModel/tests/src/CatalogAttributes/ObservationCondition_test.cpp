...
struct ObservationCondition_Fixture {
    ...
    const std::vector<Euclid::Table::Row::cell_type> values0{source_id_1, dust_row0, shift_1_row0, shift_3_row0, shift_2_row0};
...
BOOST_FIXTURE_TEST_CASE(ObservationConditionFromRow, ObservationCondition_Fixture) {
	BOOST_CHECK_THROW(Euclid::PhzDataModel::ObservationConditionFromRow(column_info_ptr, dummy_name_col_name, filter_shift_col_names), Elements::Exception);
	...
	BOOST_CHECK_NO_THROW(Euclid::PhzDataModel::ObservationConditionFromRow(column_info_ptr, dust_col_name, filter_shift_col_names_2));
	filter_shift_col_names_2.push_back(std::make_pair("Filter_4", dummy_name_col_name));
	BOOST_CHECK_THROW(Euclid::PhzDataModel::ObservationConditionFromRow(column_info_ptr, dust_col_name, filter_shift_col_names_2), Elements::Exception);
}
