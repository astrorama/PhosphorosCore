...
FilterInfo::FilterInfo(const std::pair<double, double>& filter_range, const Euclid::MathUtils::Function& filter,
                       double normalization)
    : m_range{filter_range}, m_filter{filter.clone()}, m_normalization{normalization} {}
