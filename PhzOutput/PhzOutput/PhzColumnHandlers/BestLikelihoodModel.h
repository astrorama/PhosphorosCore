...
#ifndef _PHZOUTPUT_PHZCOLUMNHANDLERS_BESTLIKELIHOODMODEL_H
#define _PHZOUTPUT_PHZCOLUMNHANDLERS_BESTLIKELIHOODMODEL_H
 ...
 *
 */
class BestLikelihoodModel : public ColumnHandler {
...
public:
   ...
   * @brief Destructor
   */
  virtual ~BestLikelihoodModel() = default;
...
}; /* End of BestLikelihoodModel class */
