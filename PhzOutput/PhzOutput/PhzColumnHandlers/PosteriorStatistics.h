...
/**
 * @file PhzOutput/PhzColumnHandlers/PosteriorStatistics.h
 * @date 07/04/16
 * @author nikoapos
 */

#ifndef _PHZOUTPUT_PHZCOLUMNHANDLERS_POSTERIORSTATISTICS_H
#define _PHZOUTPUT_PHZCOLUMNHANDLERS_POSTERIORSTATISTICS_H
 ...
 *
 */
class PosteriorStatistics : public ColumnHandler {

public:
  /**
   * @brief Destructor
   */
  virtual ~PosteriorStatistics() = default;
...
}; /* End of PosteriorStatistics class */
