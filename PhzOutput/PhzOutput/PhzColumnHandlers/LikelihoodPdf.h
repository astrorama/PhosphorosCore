...
#ifndef _PHZOUTPUT_PHZCOLUMNHANDLERS_LIKELIHOODPDF_H
#define _PHZOUTPUT_PHZCOLUMNHANDLERS_LIKELIHOODPDF_H
...
class LikelihoodPdf : public ColumnHandler {
...
#include "PhzOutput/_impl/LikelihoodPdf.icpp"
