...
struct PhotometryGridCreator_Fixture {
  ...
  public:
    ...
    DatasetProvider(std::map<Euclid::XYDataset::QualifiedName, Euclid::XYDataset::XYDataset>&& storage)
  ...
  PhotometryGridCreator_Fixture() {
    ...
    reddening_provider =
        std::unique_ptr<Euclid::XYDataset::XYDatasetProvider>{new DatasetProvider{std::move(reddenings)}};
...
BOOST_FIXTURE_TEST_CASE(Constructor_test, PhotometryGridCreator_Fixture) {
  ...
  Euclid::PhzModeling::PhotometryGridCreator gridCreator{std::move(sed_provider),
                                                         ...
                                                         {m_norm_function, m_norm_function},
                                                         m_pp_norm_function,
                                                         0};
}
...
BOOST_FIXTURE_TEST_CASE(throw_SED_test, PhotometryGridCreator_Fixture) {
  ...
  BOOST_CHECK_THROW(Euclid::PhzModeling::PhotometryGridCreator(
                        ...
                        Euclid::PhzModeling::NoIgmFunctor{}, {m_norm_function, m_norm_function}, m_pp_norm_function, 0)
                        .createGrid(axes, filter_name_list, filter_name_list, {}),
                    Elements::Exception);
}
...
BOOST_FIXTURE_TEST_CASE(throw_filter_test, PhotometryGridCreator_Fixture) {
  ...
  std::vector<Euclid::XYDataset::QualifiedName> filter_name_list{Euclid::XYDataset::QualifiedName{"filter/filter_5"},
                                                                 Euclid::XYDataset::QualifiedName{"filter/filter_2"}};
...
BOOST_FIXTURE_TEST_CASE(execution_test, PhotometryGridCreator_Fixture) {
  ...
  auto                                       photometry_grid = gridCreator.createGrid(axes, filter_name_list, filter_name_list, {});
