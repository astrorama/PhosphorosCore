...
struct PhotometryGridCreator_Fixture {
  class DatasetProvider : public Euclid::XYDataset::XYDatasetProvider {
   public:
    ...
    DatasetProvider(std::map<Euclid::XYDataset::QualifiedName,
  ...
  PhotometryGridCreator_Fixture() {
    ...
    seds.insert(
        std::make_pair(Euclid::XYDataset::QualifiedName{"sed/sed_1"}, sed_1));
    ...
    seds.insert(
        std::make_pair(Euclid::XYDataset::QualifiedName{"sed/sed_2"}, sed_2));
    ...
    seds.insert(
        std::make_pair(Euclid::XYDataset::QualifiedName{"sed/sed_3"}, sed_3));

    sed_provider = std::unique_ptr<Euclid::XYDataset::XYDatasetProvider>{
        new DatasetProvider{std::move(seds)}};
    ...
    reddenings.insert(std::make_pair(
        Euclid::XYDataset::QualifiedName{"extinction/curve_1"}, ext_1));
    ...
    reddenings.insert(std::make_pair(
        Euclid::XYDataset::QualifiedName{"extinction/curve_2"}, ext_2));

    reddening_provider = std::unique_ptr<Euclid::XYDataset::XYDatasetProvider>{
        new DatasetProvider{std::move(reddenings)}};
    ...
    filters.insert(std::make_pair(
        Euclid::XYDataset::QualifiedName{"filter/filter_1"}, filter_1));
    ...
    filters.insert(std::make_pair(
        Euclid::XYDataset::QualifiedName{"filter/filter_2"}, filter_2));

    filter_provider = std::unique_ptr<Euclid::XYDataset::XYDatasetProvider>{
        new DatasetProvider{std::move(filters)}};
...
BOOST_FIXTURE_TEST_CASE(Constructor_test, PhotometryGridCreator_Fixture) {
  ...
  std::vector<double> ebvs{0.0,   0.001, 0.002, 0.003, 0.004, 0.005,
                           0.006, 0.007, 0.008, 0.009, 0.01};
  std::vector<Euclid::XYDataset::QualifiedName> reddeing_curves{
      {"extinction/curve_1"}, {"extinction/curve_1"}};
  std::vector<Euclid::XYDataset::QualifiedName> seds{
      {"sed/sed_1"}, {"sed/sed_2"}, {"sed/sed_3"}};
  auto axes =
  ...
  std::vector<Euclid::XYDataset::QualifiedName> filter_name_list{
      Euclid::XYDataset::QualifiedName{"filter/filter_1"},
      Euclid::XYDataset::QualifiedName{"filter/filter_2"}};

  Euclid::PhzModeling::PhotometryGridCreator gridCreator{
      std::move(sed_provider), std::move(reddening_provider),
      std::move(filter_provider), Euclid::PhzModeling::NoIgmFunctor{}, m_norm_function};
}
...
BOOST_FIXTURE_TEST_CASE(throw_SED_test, PhotometryGridCreator_Fixture) {
  ...
  BOOST_CHECK_THROW(
      Euclid::PhzModeling::PhotometryGridCreator(
          std::move(sed_provider), std::move(reddening_provider),
          std::move(filter_provider), Euclid::PhzModeling::NoIgmFunctor{}, m_norm_function)
...
BOOST_FIXTURE_TEST_CASE(throw_curve_test, PhotometryGridCreator_Fixture) {
  ...
  std::vector<double> ebvs{0.0,   0.001, 0.002, 0.003, 0.004, 0.005,
                           0.006, 0.007, 0.008, 0.009, 0.01};
  std::vector<Euclid::XYDataset::QualifiedName> reddeing_curves{
      {"extinction/curve_3"}, {"extinction/curve_1"}};
  std::vector<Euclid::XYDataset::QualifiedName> seds{
      {"sed/sed_1"}, {"sed/sed_2"}, {"sed/sed_3"}};
...
BOOST_FIXTURE_TEST_CASE(throw_filter_test, PhotometryGridCreator_Fixture) {
  ...
  std::vector<Euclid::XYDataset::QualifiedName> filter_name_list{
      Euclid::XYDataset::QualifiedName{"filter/filter_5"},
      Euclid::XYDataset::QualifiedName{"filter/filter_2"}};
