...
BOOST_FIXTURE_TEST_CASE(BuildFilterInfoFunctorRange_test, BuildFilterInfoFunctor_Fixture) {
  ...
  Euclid::XYDataset::XYDataset filter_sample(
      std::vector<std::pair<double, double>>{std::make_pair(1., 1.), std::make_pair(2., 4.), std::make_pair(3., 9.),
                                             std::make_pair(4., 16.), std::make_pair(5., 25.)});
...
BOOST_FIXTURE_TEST_CASE(BuildFilterInfoFunctor_test, BuildFilterInfoFunctor_Fixture) {
  ...
  Euclid::XYDataset::XYDataset filter_sample(
      std::vector<std::pair<double, double>>{std::make_pair(1., 1.), std::make_pair(2., 2.), std::make_pair(3., 3.),
