...
Euclid::PhzModeling::NormalizationFunctor::NormalizationFunctor(PhzDataModel::FilterInfo filter_info,
                                                                double                   integrated_flux)
    : m_filter_info{std::move(filter_info)}, m_integrated_flux{integrated_flux} {}
