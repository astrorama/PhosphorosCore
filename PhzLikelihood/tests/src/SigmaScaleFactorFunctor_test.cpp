...
struct SigmaScaleFactorFunctor_Fixture {
  ...
  std::shared_ptr<std::vector<std::string>> filter_name_vector_ptr{new std::vector<std::string>{"filter_1", "filter_2"}};
  std::vector<SourceCatalog::FluxErrorPair> flux_vactor_model {
                               SourceCatalog::FluxErrorPair{2.0, 0, false, false},
  ...
  std::vector<SourceCatalog::FluxErrorPair> flux_vactor_source_a {
                            SourceCatalog::FluxErrorPair{1.0, 0.5, false, false},
  ...
  std::vector<SourceCatalog::FluxErrorPair> flux_vactor_source_b {
                             SourceCatalog::FluxErrorPair{1.0, 0.5, true, false},
