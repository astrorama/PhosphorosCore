...
public:
   ...
   *    the new one
   */
  void operator()(const SourceCatalog::FluxErrorPair& source, const SourceCatalog::FluxErrorPair& model,
...
using ScaleFactorFunctorUpperLimit =
    _Impl::ScaleFactorUpperLimit<_Impl::NormalFractionAdder, ChiSquareLikelihoodLogarithmUpperLimit>;

/// Functor for computing the scale factor which optimizes the chi square, with
/// support for upper limit and missing data
using ScaleFactorFunctorUpperLimitMissingData =
    _Impl::ScaleFactorUpperLimit<_Impl::MissingDataFractionAdder, ChiSquareLikelihoodLogarithmUpperLimitMissingData>;
