...
std::pair<bool, int> GenericGridPrior::checkCompatibility(const PhzDataModel::DoubleGrid& prior,
  ...
  if (prior.getAxesTuple() == posterior.getAxesTuple()) {
    return std::make_pair(true, -1);
             ...
             prior.getAxis<PhzDataModel::ModelParameter::EBV>() ==
                 posterior.getAxis<PhzDataModel::ModelParameter::EBV>() &&
             prior.getAxis<PhzDataModel::ModelParameter::REDDENING_CURVE>() ==
                 posterior.getAxis<PhzDataModel::ModelParameter::REDDENING_CURVE>() &&
             prior.getAxis<PhzDataModel::ModelParameter::SED>() ==
                 posterior.getAxis<PhzDataModel::ModelParameter::SED>()) {
