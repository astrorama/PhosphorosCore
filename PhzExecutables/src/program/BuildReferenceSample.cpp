...
/**
 * @file src/program/ComputeReferenceSample.cpp
 * @date 08/13/18
 * @author aalvarez
 */
...
static Elements::Logging logger = Elements::Logging::getLogger("BuildReferenceSample");
...
public:
  ...
  Elements::ExitCode mainMethod(std::map<std::string, po::variable_value>& args) override {
    ...
    PhzExecutables::BuildReferenceSample{}.run(config_manager);
